 ...
 * @author Ookee
 */
public class SOVratiRatu extends AbstractGenericOperation {

    private GeneralEntity rata;
    ...
    protected void execute(Object entity) throws Exception {
        rata = dbBroker.findRecord((GeneralEntity) entity);
        Rata r = (Rata) rata;
